...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.oscilloscopeGraphic = OscilloscopeGraphic(self.ui.graphicsView, self.scene)
...
if __name__ == "__main__":
    ...
    eventHandler = EventHandler(application.ui, application.oscilloscopeGraphic, I2CHandler())
    eventHandler.start()
